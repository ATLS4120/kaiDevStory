...
enum Constants {
    static let ChapterOneMindstorms = "chapterI = I believe I started my programming journey in middle school when we worked on Lego Mindstorms for our engineering class. I was also in a robotics club used Lego Mindstorms but I don’t remember anything about Mindstorms."
    ...
    static let ChapterSixStarsUI = "<p>Over the summer of 2023 I got an internship with Annie Margaret working on an Values based application that would allow people to journal and align how they feel to a value. I was apart of the UI/UX team and mainly worked on interviews and documenting interaction with the Figma Prototype.<p>"
    ...
    static let ChapterEightArduinoBeach = "Serial.Print(“I became very familiar with Arduino as my next coding language due to a class called Object. For this class my end goal was to make a device that would communicate to cars behind you when they are tailgating you or when you are merging. This was done using neopixels and radio transmitters in order to communicate.”)"

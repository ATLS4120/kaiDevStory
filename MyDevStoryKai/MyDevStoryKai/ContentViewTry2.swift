...
//                        .foregroundColor(Color(red: 0.92, green: 0.93, blue: 0.84))
//                    
//                    NavigationLink(names[0], destination: ChapterOne())
////                        Text(chapterView(chapter: names[0]))
////                            .frame(width: 300, height: 80)
////                            .font(.custom("AmericanTypewriter", size: 30))
////                            .padding()
////                            .background(Color(red: 0.92, green: 0.93, blue: 0.84))
...
//                    
//                    
//                    NavigationLink(names[1], destination: ChapterTwo())
//                    NavigationLink(names[2], destination: ChapterThree())
//                    NavigationLink(names[3], destination: ChapterFour())
//                    NavigationLink(names[4], destination: ChapterFive())
//                    NavigationLink(names[5], destination: ChapterSix())
//                    NavigationLink(names[6], destination: ChapterSeven())
//                    NavigationLink(names[7], destination: ChapterEight())
//                    NavigationLink(names[8], destination: ChapterNine())
